...
export async function getStaticPaths() {
  ...
  // Match the post route's visibility rules (postFilter) so scheduled posts
  // don't get a guessable OG image exposing their title before publication.
